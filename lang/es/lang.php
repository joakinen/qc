...
$lang['admin_desc']     = 'Aquí se muestran las %d páginas con mayor cantidad de FIXMEs y peor índice de calidad. Haga click en una celda de título para ordenar la lista. Este resumen es actualizado a diario.';
$lang['admin_page']     = 'Página';
$lang['admin_quality']  = 'Calidad';
$lang['admin_fixme']    = 'Fixme';

$lang['intro_h']       = 'Análisis de página';

$lang['g_created']     = 'Creada:';
$lang['g_modified']    = 'Última modificación:';
$lang['g_words']       = 'Palabras:';
$lang['g_chars']       = 'Caracteres:';
$lang['g_changes']     = 'Número de ediciones:';
$lang['g_authors']     = 'Top Authors:';

$lang['anonymous']     = 'Anónimos';

$lang['i_qcscore']     = 'Calidad:';

$lang['errorsfound_h'] = 'Identificados posibles problemas de calidad';
$lang['errorsfound']   = 'Tras analizar la estructura de la página se han identificado varios posibles problemas de legibilidad y usabilidad. Por favor, analiza los puntos que se muestran a continuación para ver si es posible corregirlos. tenga en cuenta que esto es un análisis automático - debe usted mismo juzgar si estos problemas lo son realmente.';
